...
export default function PedidoDetailModal({ open, onClose, pedido }) {
  ...
  const asignado = pedido.asignado_a
    ? db.usuarios.find((u) => u.id === pedido.asignado_a)
    : null;
        ...
        <div>
          ...
          {[
            ...
            <div key={k} style={{ marginBottom: 14 }}>
              ...
              <p
                style={{
                  fontSize: k === "Cliente" ? 15 : 13,
                  fontWeight: k === "Cliente" ? 500 : 400,
                  color: k === "Cliente" ? "var(--text-1)" : "var(--text-2)",
                  marginTop: 2,
                }}
              >
                {v}
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          >
            ...
            {[
              ...
              ["PDF", pedido.pdf_ruta],
              ["Asignado", asignado ? asignado.nombre : "Sin asignar"],
            ].map(([k, v]) => (
              <div
                key={k}
                style={{
