    ...
    <div style={{ padding: 28 }}>
      ...
      {filtered.length === 0 ? (
        <EmptyState
          icon="archive"
          title="Sin registros"
          subtitle="Las entregas aparecerán aquí"
        />
      ) : (
        <div
          style={{
              ...
              {filtered.map((h, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td style={{ padding: "11px 16px" }}>
                      <Badge
                        color={pri?.color || "#6B7280"}
                        style={{ fontSize: 10 }}
                      >
                        {pri?.label || h.prioridad}
                      </Badge>
                    </td>
                    <td
                      style={{
