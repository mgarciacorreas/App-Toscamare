...
export default function LoginScreen() {
  ...
  return (
    <div
      style={{ minHeight: "100vh", display: "flex", background: "var(--bg-0)" }}
    >
      {/* Left panel */}
      <div
        style={{
          ...
          alignItems: "center",
          background:
            "linear-gradient(145deg, #0E1017 0%, #14161E 50%, #0E1017 100%)",
          ...
          >
            {Object.entries(ESTADOS).map(([k, v], i) => (
              ...
              >
                ...
                {i < 3 && (
                  <SVG name="chevronR" size={12} color="var(--text-4)" />
                )}
              </div>
            ))}
          </div>
      ...
      >
        <div className="anim-fade d2">
          ...
          <form onSubmit={handleSubmit}>
            ...
            {error && (
              <div
                className={shaking ? "anim-shake" : "anim-fade"}
                style={{
                  padding: "10px 14px",
                  marginBottom: 16,
                  borderRadius: "var(--r2)",
              ...
              >
                <SVG name="alert" size={15} color="var(--danger)" />
                {error}
              </div>
            )}
            <Btn
                  ...
                  >
                    <code
                      style={{
                        fontFamily: "var(--mono)",
                        fontSize: 12,
                        color: ROLE_META[u.rol].color,
                      }}
                    >
                      {u.username}
                    </code>
                    <span style={{ fontSize: 10, color: "var(--text-4)" }}>
                      {ROLE_META[u.rol].label}
                    </span>
                  </div>
                ))}
            </div>
